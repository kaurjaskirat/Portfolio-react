...
const Contact = () => {
    return(
        ...
        <div style={{width:"100%",padding:"50px",backgroundColor:"rgb(27, 16, 74)",marginBottom:"70%"}} className='Contact'>
            ...
            <div style={{marginLeft:"15%",marginTop:"-43%",marginBottom:"80%",fontSize:"200%",backgroundColor:"white",width:"4%",jusifyContent:"center",boxShadow:"0 0 3px 2px rgba(14, 13, 16, 0.5)",textAlign:"center"}} ><HiMail/></div>
